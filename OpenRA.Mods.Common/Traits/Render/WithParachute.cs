...
namespace OpenRA.Mods.Common.Traits.Render
{
	...
	public class WithParachute : ConditionalTrait<WithParachuteInfo>, ITick, IRender
	{
		...
		IEnumerable<IRenderable> IRender.Render(Actor self, WorldRenderer wr)
		{
			...
			var tint = new float3(info.ShadowColor.R, info.ShadowColor.G, info.ShadowColor.B) / 255f;
			var a = info.ShadowColor.A / 255f;
			return new IRenderable[] { new SpriteRenderable(shadow.Image, pos, info.ShadowOffset, info.ShadowZOffset, palette, 1, a, tint, tintModifiers, true) };
		}
